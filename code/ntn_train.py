...
def run_training():
    ...
    train_data, num_entities, num_relations, entity_list = dataprocessing.index_data(train_data,
                                                                                     entity_list,
                                                                                     entity_indices,
                                                                                     relation_list)
    ...
    #                                                             corrupt_size,
    #                                                             entity_list)
    # print('Shape of train_data: {}. Shape of corrupting_batch: {}'.format(np.array(train_data).shape,
    #                                                                       np.array(corrupting_batch).shape))
    # exit()
    # =========================================================================
