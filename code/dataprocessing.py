...
def index_data(data, entity_list, entity_indices, relation_list):
    print('Sample data')
    # filter entity
    fil_entity_list = random.sample(entity_list, 5000)
    # filter triple
    ...
    return indexing_data, len(fil_entity_list), len(relation_list), fil_entity_indices


def generate_corrupting_batch(batch_size, data, num_entities, corrupt_size):
